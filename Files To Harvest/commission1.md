...
Plasticos/plasticos_transaction/models/commission_rule.py
...
access_commission_rule_admin,commission.rule.admin,model_plasticos_commission_rule,base.group_system,1,1,1,1
🖥 VIEWS
Plasticos/plasticos_transaction/views/commission_rule_views.xml
<odoo>
    <record id="view_commission_rule_tree" model="ir.ui.view">
        <field name="name">commission.rule.tree</field>
        <field name="model">plasticos.commission.rule</field>
